...
export const metadata: Metadata = {
  ...
  title: {
    template: '%s - 欧易(OKX)网址入口',
    default: '欧易OKX下载中心 | 欧易交易所网页版/APP/电脑版安全下载',
  },
  description: '欧易(OKX)中文服务入口，为您提供欧易交易所电脑客户端下载、手机端APP安全下载网址、网页版登录直达及Web3钱包使用指南。安全稳定，资深粉丝实时同步。',
  openGraph: {
    type: 'website',
    locale: 'zh_CN',
    url: 'https://ouyipc.com',
    siteName: '欧易(OKX)下载中心',
    title: '欧易OKX下载中心 | 欧易交易所网页版/APP/电脑版安全下载',
    description: '欧易(OKX)中文服务入口，为您提供欧易交易所电脑版及手机版最新安全下载链接。',
  },
  icons: {
    icon: '/favicon.ico',
